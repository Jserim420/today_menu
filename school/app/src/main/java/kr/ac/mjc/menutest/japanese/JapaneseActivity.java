...
import kr.ac.mjc.menutest.korean.kor_DegreeFlavor;
import kr.ac.mjc.menutest.korean.kor_DegreeSpicy;
import kr.ac.mjc.menutest.korean.kor_DegreeTemp;
import kr.ac.mjc.menutest.korean.kor_TypeBeef;

public class JapaneseActivity extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.japanese_main);
        ...
        riceBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(JapaneseActivity.this, jap_DegreeSpicy.class);
        ...
        noodleBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(JapaneseActivity.this, jap_DegreeTemp.class);
                startActivity(intent);
            }
        });
        ...
        beefBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(JapaneseActivity.this, jap_TypeBeef.class);
                startActivity(intent);
            }
        });
