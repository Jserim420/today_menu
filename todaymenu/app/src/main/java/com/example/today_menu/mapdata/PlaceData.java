...
public class PlaceData {
    ...
    String addressUrl = "https://dapi.kakao.com/v2/local/geo/coord2address?";
    String firstAdd, secondAdd, thirdAdd;

    public ArrayList<Place> getPlace(int i, String currentAdd, String keyword) {
        //return과 관련된 부분
...
//                    }
    ...
    public String getAddress(int addressNo, double x, double y) {
        //return과 관련된 부분
        ArrayList<Place> dataArr = new ArrayList<Place>();
        Place Place = new Place();
...
//                        String fullURL = apiUrl + "&page=" + i;
                    URL url = new URL(addressUrl+ "x=" + x + "&y=" + y);
                    HttpsURLConnection myConnection = (HttpsURLConnection) url.openConnection();
                    myConnection.setRequestProperty("Authorization", "KakaoAK " + auth);
