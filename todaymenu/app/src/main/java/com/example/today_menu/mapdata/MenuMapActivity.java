...
public class MenuMapActivity extends AppCompatActivity implements MapView.CurrentLocationEventListener, MapView.MapViewEventListener, MapReverseGeoCoder.ReverseGeoCodingResultListener {

    private static final String LOG_TAG = "MenuMapActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menumap);
        String keyword = getIntent().getStringExtra("MenuResult");
        ...
        Button findResBtn = findViewById(R.id.find_res_btn);
        ...
        currentAdd = placeData.getAddress(3, currentLng, currentLat);
        ...
        againBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MenuMapActivity.this, MainActivity.class);
                startActivity(intent);
            }
        });

        findResBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MenuMapActivity.this, MainActivity.class);
                startActivity(intent);
    ...
    private void drawPlace(String currentAdd, String keyword) {
        for (int i = 1; i < 46; i++) {
            ArrayList<Place> dataArr = placeData.getPlace(i, currentAdd, keyword);
...
//            Log.d("MapActivity", data.getName()+", " + data.getLatitude());
    ...
    private void getGeo() {
        mapView.setCurrentLocationTrackingMode(MapView.CurrentLocationTrackingMode.TrackingModeOnWithoutHeading);
        mReverseGeoCoder = new MapReverseGeoCoder("6dd936323c9993cfe5d691918c46476a", mapPoint, MenuMapActivity.this, MenuMapActivity.this);
        ...
        if (permsRequestCode == PERMISSIONS_REQUEST_CODE && grandResults.length == REQUIRED_PERMISSIONS.length) {
            ...
            if (check_result) {
                ...
                if (ActivityCompat.shouldShowRequestPermissionRationale(this, REQUIRED_PERMISSIONS[0])) {
                    Toast.makeText(MenuMapActivity.this, "퍼미션이 거부되었습니다. 앱을 다시 실행하여 퍼미션을 허용해주세요.", Toast.LENGTH_LONG).show();
                    finish();
                } else {
                    Toast.makeText(MenuMapActivity.this, "퍼미션이 거부되었습니다. 설정(앱 정보)에서 퍼미션을 허용해야 합니다. ", Toast.LENGTH_LONG).show();
                }
            }
        }
    }
    void checkRunTimePermission(){
        ...
        int hasFineLocationPermission = ContextCompat.checkSelfPermission(MenuMapActivity.this,
        ...
        if (hasFineLocationPermission == PackageManager.PERMISSION_GRANTED ) {
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(MenuMapActivity.this, REQUIRED_PERMISSIONS[0])) {
                // 3-2. 요청을 진행하기 전에 사용자가에게 퍼미션이 필요한 이유를 설명해줄 필요가 있습니다.
                Toast.makeText(MenuMapActivity.this, "이 앱을 실행하려면 위치 접근 권한이 필요합니다.", Toast.LENGTH_LONG).show();
                // 3-3. 사용자게에 퍼미션 요청을 합니다. 요청 결과는 onRequestPermissionResult에서 수신됩니다.
                ActivityCompat.requestPermissions(MenuMapActivity.this, REQUIRED_PERMISSIONS,
    ...
    private String onFinishReverseGeoCoding(String result) {
        Toast.makeText(MenuMapActivity.this, "현재위치 : " + result, Toast.LENGTH_SHORT).show();
        return result;
    }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            case R.id.logout:
                ...
                Intent intent = new Intent(MenuMapActivity.this, LoginActivity.class);
                startActivity(intent);
                break;
            case R.id.account:
                //select account item
